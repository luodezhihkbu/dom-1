...
window.dom = {
  create: function create(string) {
    ...
    var container = document.createElement("template"); // template用于创建各类元素
  ...
  find: function find(selector, scope) {
    ...
    return (scope || document).querySelectorAll(selector); // 如果有scope就调用scope.querySelectorAll,如果没有就调用document.querySelectorAll
